...
public class SistemaGaleria extends JFrame {
    ...
    private void criarPainelPrincipal() {
        ...
        panel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(),
                "Menu Principal", TitledBorder.CENTER, TitledBorder.TOP, new Font("Arial", Font.BOLD, 18)));
        panel.setLayout(new GridBagLayout());
        GridBagConstraints gbc = new GridBagConstraints();

        JLabel titulo = new JLabel("Sistema de Gerenciamento de Galeria", SwingConstants.CENTER);
